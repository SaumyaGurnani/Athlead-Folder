...
class _EventsScreenState extends State<EventsScreen>
  ...
  void _initializeEvents() {
    ...
    eventProvider.initializeRegisteredEvents(userId);
    eventProvider.initializeInterestedEvents(userId);
  }
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: const [
                _EventsList(type: EventListType.all),
                _EventsList(type: EventListType.upcoming),
                _EventsList(type: EventListType.myEvents),
              ],
            ),
          ),
        ],
...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  DateTime? _startDate;
  DateTime? _endDate;
  EventType _selectedType = EventType.competition;
